...
webpack入口必须要是一个.js文件吗，不能是html文件吗
...
vs强制更新，强制更新用于css,另外一个用于js



一个很常见的知识点，bundle??还是啥

分析json文件，感觉像vue的浏览器插件

![image-20251221003149910](C:\Users\朱德成\AppData\Roaming\Typora\typora-user-images\image-20251221003149910.png)



proxy

![image-20251220235625391](C:\Users\朱德成\AppData\Roaming\Typora\typora-user-images\image-20251220235625391.png)

跨域的问题，这个之前遇到过

![image-20251221000003660](C:\Users\朱德成\AppData\Roaming\Typora\typora-user-images\image-20251221000003660.png)

为什么这样子配，可以绕过去



![image-20251221000306991](C:\Users\朱德成\AppData\Roaming\Typora\typora-user-images\image-20251221000306991.png)

devtools选项是干什么的，有哪些选项
...
tree shaking是啥，感觉也是一种优化策略，函数编程，贴合，为了让它生效。roll up最长使用

压缩与混淆，还很重要

lodash感觉是个很常用的包，这个是干什么的，在前端里面
